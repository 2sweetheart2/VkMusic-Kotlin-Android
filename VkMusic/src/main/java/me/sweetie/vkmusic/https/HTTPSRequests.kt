package me.sweetie.vkmusic.https
...
class HTTPSRequests {
    ...
    companion object{
        ...
        fun sendPost(url: String, parameters: JSONObject, callback: Callback) {
            Thread {
                try {
                    val httpClient: HttpsURLConnection
                    httpClient = URL(url).openConnection() as HttpsURLConnection
